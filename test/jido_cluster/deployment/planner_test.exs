defmodule JidoCluster.Deployment.PlannerTest do
  use ExUnit.Case, async: true
  alias Jido.Cluster.Deployment.Planner
  alias JidoCluster.Test.CapacityTopology, as: CapacityAdmission
  ...
  test "unsupported group definitions are rejected rather than partly admitted" do
    definition =
      Jido.Topology.new!(
        name: "groups",
        groups: [%{key: "workers", module: JidoCluster.Test.PlacementWorker, count: 2}]
      )
