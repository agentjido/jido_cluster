...
| --- | --- | --- |
| Keyed routing | [InstanceManager](../../../lib/jido/cluster/instance_manager.ex); [peer tests](../../../test/jido_cluster/distributed/v3_foundation_test.exs) | Manager/key interface; no public distributed Ref directory |
...
| Placement | [Topology helper](../../../lib/jido/cluster/topology.ex) uses rendezvous hashing | Selection only; standby output is not a live replica |
...
| Local activation | [LocalManager](../../../lib/jido/cluster/internal/local_manager.ex) starts temporary core Agents under a manager-owned Jido instance | Recovery is requested by later manager work; no independent recovery queue |
...
| Saved-state recovery | [Mnesia adapter](../../../lib/jido/cluster/storage/mnesia.ex), core records, replicated RAM example | Application owns Mnesia topology; local ETS cannot provide cross-node recovery |
